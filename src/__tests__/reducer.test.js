...
describe('reducer tests', () => {
  ...
  test('ADD_ITEM', () => {
    ...
    expect(state).toEqual({ kegs: [{ name: 'test', brand: 'test', pricePerPint: 0.00, alcoholContent: 0.0, pintsRemaining: 124, isGlutenFree: false, isVegan: false, key: 1 }] });
  });

  test('UPDATE_ITEM', () => {
    let state = { kegs: [{ name: 'test', brand: 'test', pricePerPint: 0.00, alcoholContent: 0.0, pintsRemaining: 124, isGlutenFree: false, isVegan: false, key: 1 }] };
    ...
    expect(state).toEqual({ kegs: [{ name: 'test3', brand: 'test2', pricePerPint: 5.00, alcoholContent: 5.0, pintsRemaining: 120, isGlutenFree: true, isVegan: true, key: 1 }] });
  });
